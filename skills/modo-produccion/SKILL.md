...
- Qué archivo es el principal (por ejemplo `index.html` o ruta del proyecto).
- Objetivo de la revisión: “lista para enseñar” o “lista para publicar”.
...
- Nivel de libertad: Baja / Media (aplicar correcciones exactas sobre una base existente).
